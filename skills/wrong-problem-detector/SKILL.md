...
1. **The Symptom Test** — Are you solving a symptom or a cause?
2. **The Audience Test** — Whose problem is this actually?
3. **The Verb Test** — What if the action is wrong?
4. **The Frame Test** — What if the opposite problem is the real one?
5. **The Existence Test** — What if this problem doesn't need to exist?
