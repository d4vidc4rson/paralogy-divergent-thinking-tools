...
1. **Name the territory** — What space are we generating questions about?
2. **Map the assumptions** — What does everyone in this space take for granted?
3. **Generate the questions** — Produce 15-20 questions nobody is asking
4. **Star the dangerous ones** — Find the 3-5 that make experts flinch
